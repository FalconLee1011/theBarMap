...
<head>
  ...
  <script src="./map_cluster_php.js"></script>
</head>
      ...
      <div class="flipper">
        <div class="front">
          ...
          <div class="detaillevel">
            <img src="./res/star.png" id="star1" class="star"><img src="./res/star.png" id="star2" class="star"><img
              src="./res/star.png" id="star3" class="star"><img src="./res/star.png" id="star4" class="star"><img
              src="./res/star.png" id="star5" class="star">
            <span class="level" id="level">4</span>
            <button onclick="document.getElementById('fl').classList.toggle('hover');$('body').toggleClass('body');"
              id="opinion"><span>新增評價</span></button>
          </div>
        ...
        <div class="back">
          <div class="form">
            ...
            <form method="post" action="http://">
              ...
              <label>
                <div class="upbtn">+</div>
                <input name="img" id="img" type="file" accept="image/*" multiple="multiple" style="display:none;"
