...
$(document).ready(function(){
  $(".forstar #s1").hover(function(){
    $(".forstar #s1").attr("src","star.png");
    $(".forstar #s2,#s3,#s4,#s5").attr("src","nstar.png");
    });
  $(".forstar #s2").hover(function(){
    $(".forstar #s2,#s1").attr("src","star.png");
    $(".forstar #s3,#s4,#s5").attr("src","nstar.png");
    });
  $(".forstar #s3").hover(function(){
    $(".forstar #s3,#s2,#s1").attr("src","star.png");
    $(".forstar #s4,#s5").attr("src","nstar.png");
    });
  $(".forstar #s4").hover(function(){
    $(".forstar #s3,#s4,#s2,#s1").attr("src","star.png");
    $(".forstar #s5").attr("src","nstar.png");
    });
  $(".forstar #s5").hover(function(){
    $(".forstar #s1,#s2,#s3,#s4,#s5").attr("src","star.png");
    });
...
function nowstar(){
  if($('input[name="level"]').val()==1){
    ...
    $("input[name='level']").val(5);
    $(".forstar #s2,#s1,#s3,#s4,#s5").attr("src","star.png");
  }
}
